...
if (isset($_POST["email"]) && isset($_POST["passcode"])){
    if(!empty($_POST["email"]) && !empty($_POST["passcode"])){
        ...
        if($count > 0){
            ...
            extract($row);
            if(password_verify($pass,$passcode) && $isAdmin == 1){
        ...
        echo "<div class='alert alert-danger'>Please ensure you are a registered admin and your password is correct!</div>"; 
...
<div>
<h3 class = "heading"> Welcome Back Admin:) </h3>
<br/>
